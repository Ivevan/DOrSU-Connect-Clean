...
**Generated:** 11/30/2025, 10:06:26 PM
...
- **Total Queries:** 20
- **Average Retrieval Relevance:** 66.4%
- **Average Context Accuracy:** 68.4%
- **Average Hallucination Score:** 93.0% (higher is better)
- **Average Answer Correctness:** 78.3%
- **Overall Score:** 76.5%
...
|----------|-------|---------------------|-----------------|-------------------|-------------------|
| schedule | 10 | 62.9% | 63.9% | 86.0% | 56.7% |
...
|-------------|-------|---------------------|-----------------|-------------------|-------------------|
| schedule_data | 10 | 62.9% | 63.9% | 86.0% | 56.7% |
...
- **Retrieval Relevance:** 28.6% (2/7 facts found)
- **Context Accuracy:** 38.6% (2/7 facts, KB used: Yes)
...
```
I don't have that specific information in the knowledge base yet. However, I can suggest checking the DOrSU schedule events for the upcoming Commencement Exercises for AY 2024-2025.
```
...
6/23/2025, june, june 23, 6/27/2025, june
...
**Issue:** The AI claimed it doesn't have information, but:
- Context Accuracy is 38.6% (chunks were retrieved correctly)
- Knowledge Base was used: Yes
- Ground truth facts exist: 7 facts
...
- **Retrieval Relevance:** 0.0% (0/4 facts found)
- **Context Accuracy:** 0.0% (0/4 facts, KB used: Yes)
- **Hallucination Score:** 60.0% (Has hallucinations)
- **Answer Correctness:** 0.0% ❌
...
- Context Accuracy is 0.0% (chunks were retrieved correctly)
- Knowledge Base was used: Yes
- Ground truth facts exist: 4 facts

**Root Cause:** This indicates a **response generation failure** - the retrieval system found the correct information, but the AI model failed to use it in the response. This is different from retrieval failure.

#### Metadata

- **Response Time:** 16009ms
- **Model:** llama-3.1-8b-instant
- **Used Knowledge Base:** Yes
...
```
According to the schedule events, the deadline for submission of the Report of Grades is December 31, 2025.
```
...
```
The GAD Summit is scheduled for November 2025 (month-only event, no specific date).
```
...
```
November 1997 (1997-11): San Isidro Campus established.
```
