        ...
        <Animated.View
          style={[
            styles.cloudWrapper,
            {
              ...
              right: '12%',
              transform: [
                { translateX: lightSpot1.interpolate({ inputRange: [0, 1], outputRange: [0, -15] }) },
                { translateY: lightSpot1.interpolate({ inputRange: [0, 1], outputRange: [0, 12] }) },
                { scale: lightSpot1.interpolate({ inputRange: [0, 0.5, 1], outputRange: [1, 1.08, 1] }) },
              ],
            },
          ]}
        >
        ...
        <Animated.View
          style={[
            styles.cloudWrapper,
            {
              ...
              left: '8%',
              transform: [
                { translateX: lightSpot2.interpolate({ inputRange: [0, 1], outputRange: [0, 18] }) },
                { translateY: lightSpot2.interpolate({ inputRange: [0, 1], outputRange: [0, -10] }) },
                { scale: lightSpot2.interpolate({ inputRange: [0, 0.5, 1], outputRange: [1, 1.06, 1] }) },
              ],
            },
          ]}
        >
        ...
        <Animated.View
          style={[
            styles.cloudWrapper,
            {
              ...
              left: '55%',
              transform: [
                { translateX: lightSpot3.interpolate({ inputRange: [0, 1], outputRange: [0, -20] }) },
                { translateY: lightSpot3.interpolate({ inputRange: [0, 1], outputRange: [0, 8] }) },
                { scale: lightSpot3.interpolate({ inputRange: [0, 0.5, 1], outputRange: [1, 1.1, 1] }) },
              ],
            },
          ]}
        >
        ...
        <Animated.View
          style={[
            styles.cloudWrapper,
            {
              ...
              left: '10%',
              transform: [
                { translateX: cloudAnim1.interpolate({ inputRange: [0, 1], outputRange: [0, 20] }) },
                { translateY: cloudAnim1.interpolate({ inputRange: [0, 1], outputRange: [0, -15] }) },
              ],
            },
          ]}
        >
        ...
        <Animated.View
          style={[
            styles.cloudWrapper,
            {
              ...
              right: '15%',
              transform: [
                { translateX: cloudAnim2.interpolate({ inputRange: [0, 1], outputRange: [0, -25] }) },
                { translateY: cloudAnim2.interpolate({ inputRange: [0, 1], outputRange: [0, 10] }) },
              ],
            },
          ]}
        >
